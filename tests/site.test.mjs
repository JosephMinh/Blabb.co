...
assert.match(phoneScene, /showcaseScale = THREE\.MathUtils\.clamp\(viewport\.height \/ 1240, 0\.58, 0\.68\)/);
...
assert.match(phoneScene, /targetScale\.setScalar\(Math\.min\(0\.62, showcaseScale \* 0\.92\)\)/);

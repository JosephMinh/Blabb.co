...
- Seven independently animated assembly groups: rear shell, battery and coil,
  mainboard/local engine, midframe, metal rails, display bed, and front glass.
...
- Build the handset as an original Blender-generated GLB with named, separable
  hardware meshes; keep its generator script in the repository.
...
- Include named separable layers for shell, battery, mainboard/local engine,
  midframe, rails, display, and glass. Use actual component depth and staggered
  assembly motion to make the exploded view legible.

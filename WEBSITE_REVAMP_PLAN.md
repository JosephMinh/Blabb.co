...
- One 582 KiB GLB with 20,628 triangles and 32 named exterior meshes,
  generated by `tools/generate_phone_model.py`.
- One permanently assembled handset built around a single continuous plum
  enclosure with a realistic 12%-of-width depth profile, glass seated into a
  shallow display recess, rear finish, camera bar, and restrained edge buttons.
...
- Use one continuous enclosure for the back, sides, corners, and front bezel.
  Seat the glass in a shallow shell recess, cut bottom I/O into the enclosure,
  and limit protrusions to legitimate exterior details, chiefly the rear camera
  bar and tactile buttons. Do not model interior parts.
